        ...
        <div className="p-8 max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <header className="space-y-2">
                <div className="flex items-center gap-3">
                    ...
                    <h1 className="text-3xl font-black tracking-tight text-slate-900">Price Printables</h1>
                </div>
                <p className="text-slate-500 font-medium ml-12">Generate and print professional product price lists by salesman, supplier, segment, and category.</p>
            </header>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="p-6 bg-white rounded-3xl shadow-lg shadow-slate-100 border border-slate-100 flex flex-col items-center text-center gap-3">
                    ...
                    <p className="text-xs text-slate-400 font-medium">Pick a salesman, supplier, segment, and category.</p>
                </div>
                <div className="p-6 bg-white rounded-3xl shadow-lg shadow-slate-100 border border-slate-100 flex flex-col items-center text-center gap-3">
