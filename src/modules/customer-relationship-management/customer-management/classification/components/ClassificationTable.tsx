...
import { ChevronLeft, ChevronRight, MoreHorizontal, Tags, User } from "lucide-react";
...
export function ClassificationTable({ data, isLoading, onView, onEdit }: ClassificationTableProps) {
