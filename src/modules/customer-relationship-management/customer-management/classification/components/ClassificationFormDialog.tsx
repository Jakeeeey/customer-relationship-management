...
export function ClassificationFormDialog({
    ...
    useEffect(() => {
        if (open) {
            setClassificationName(selectedItem?.classification_name ?? "");
        }
    }, [open, selectedItem]);
    ...
    const title =
        mode === "create" ? "Create Classification" : mode === "edit" ? "Edit Classification" : "View Classification";

    const description =
        mode === "create"
            ? "Add a new classification type for customer management."
            : mode === "edit"
                ...
                <div className="space-y-5 px-6 py-6">
                    <div className="rounded-xl border bg-card p-4 shadow-sm">
                        ...
                        <p className="mt-2 text-xs text-muted-foreground">
                            This value is used for customer grouping and reporting.
                        </p>
                    </div>
