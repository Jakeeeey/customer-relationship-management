...
// --- Header Schema ---
export const DealerInvoiceHeaderSchema = z.object({
...
export type DealerInvoiceHeader = z.infer<typeof DealerInvoiceHeaderSchema> & {
...
// --- Detail Schema ---
export const DealerInvoiceDetailSchema = z.object({
...
export type DealerInvoiceDetail = Omit<z.infer<typeof DealerInvoiceDetailSchema>, 'product_id'> & {
