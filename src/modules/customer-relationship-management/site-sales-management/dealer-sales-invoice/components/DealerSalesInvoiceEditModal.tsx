...
import { DealerInvoiceHeader, DealerInvoiceDetail, LinkedDocument } from "../types";
...
interface DealerSalesInvoiceEditModalProps {
    isOpen: boolean;
    onClose: () => void;
    invoice: DealerInvoiceHeader | null;
}

export const DealerSalesInvoiceEditModal: React.FC<DealerSalesInvoiceEditModalProps> = ({ isOpen, onClose, invoice }) => {
    ...
    const { fetchDetails, saveAdjustments } = useDealerSalesInvoice();
    ...
    const handleSave = async () => {
        ...
        setIsSaving(true);
        try {
            await saveAdjustments(invoice.invoice_id.toString(), {
    ...
    const updateDetail = (index: number, field: keyof DealerInvoiceDetail, value: string | number) => {
                    ...
                    <div className="flex justify-between items-center">
                        <div>
                            <DialogTitle className="text-xl font-bold text-slate-800">
                                Edit Dealer Transaction: {invoice?.invoice_no}
                            </DialogTitle>
