                ...
                <div className="bg-gradient-to-br from-indigo-500/10 via-purple-500/5 to-transparent p-8">
                    <DialogHeader className="space-y-4">
                        ...
                        <div className="text-center space-y-1">
                            <DialogTitle className="text-2xl font-black tracking-tight text-slate-900 uppercase">Confirm Order Flow</DialogTitle>
                        ...
                        <div className="mt-6 p-4 rounded-2xl bg-amber-500/5 border border-amber-200/50 flex gap-4 items-start animate-in fade-in slide-in-from-top-2 duration-500">
                            ...
                            <div className="flex flex-col">
                                ...
                                <span className="text-[11px] font-medium text-amber-600/80 leading-relaxed mt-0.5">
                                    Some items have zero allocation. Would you like to save this as a <strong>Draft</strong> for later fulfillment or proceed directly to <strong>Approval</strong>?
                                </span>
                            </div>
                        </div>
                    )}
                    ...
                    <div className="grid grid-cols-1 gap-3 mt-8">
                        ...
                        >
                            ...
                            <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest opacity-60 italic">Bypass Draft Workflow</span>
                        </Button>
                    </div>
