...
// --- Header Schema ---
export const StockPurchaseHeaderSchema = z.object({
    ...
    isPaid: z.boolean().or(z.number().transform(n => n === 1)).nullable().optional(),
...
export type StockPurchaseHeader = z.infer<typeof StockPurchaseHeaderSchema> & {
...
// --- Detail Schema ---
export const StockPurchaseDetailSchema = z.object({
...
export type StockPurchaseDetail = Omit<z.infer<typeof StockPurchaseDetailSchema>, 'product_id'> & {
