...
import InvoiceOnholdPage from "@/modules/customer-relationship-management/system-management/invoice-onhold/InvoiceOnholdPage";

export const metadata = {
  title: "Invoice Onhold | System Management",
  description: "Manage sales orders waiting for invoicing",
};
