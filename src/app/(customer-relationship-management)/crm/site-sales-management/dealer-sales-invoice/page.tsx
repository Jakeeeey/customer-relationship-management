...
import { DealerSalesInvoicePostingPage } from "@/modules/customer-relationship-management/site-sales-management/dealer-sales-invoice";
                        ...
                        <Breadcrumb>
                            <BreadcrumbList className="min-w-0 overflow-hidden">
                                <BreadcrumbItem className="hidden md:block shrink-0">
                                    <BreadcrumbLink href="#">Site Sales</BreadcrumbLink>
                                </BreadcrumbItem>
