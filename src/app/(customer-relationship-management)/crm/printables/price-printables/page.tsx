...
import { PricePrintablesModule } from "@/modules/customer-relationship-management/printables/price-printables";

export const runtime = "nodejs";
export const dynamic = "force-dynamic";

export const metadata = {
    title: "Price Printables | CRM",
    description: "Generate and print product price lists by salesman, supplier, segment, and category.",
};
...
export default async function PricePrintablesPage() {
