...
import DealershipModule from "@/modules/customer-relationship-management/customer-management/dealer-list/DealerListModule";
                    ...
                    <div className="min-w-0 overflow-hidden">
                        <Breadcrumb>
                            <BreadcrumbList className="min-w-0 overflow-hidden">
                                ...
                                <BreadcrumbSeparator className="hidden md:block shrink-0" />                                <BreadcrumbItem className="hidden md:block shrink-0">
