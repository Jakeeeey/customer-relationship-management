...
import { EmployeeStockPurchaseModule, EmployeeStockPurchaseProvider } from "@/modules/customer-relationship-management/employee-stock-purchase/creation";
...
export default async function EmployeeStockPurchasePage() {
